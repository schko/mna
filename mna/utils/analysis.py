...
def get_relevant_labels_mappings(path_to_base_package):
    """
    ...
    regions_in_activity = ['premotor', 'intermediate_frontal', 'dlpfc'] # should map to the brodmann_area_to_func json file and the corresponding brodmann_mappings dict
