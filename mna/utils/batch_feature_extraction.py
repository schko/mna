...
def clean_up_adadrive_trials(all_dfs):
    ...
    all_dfs_final = all_dfs_final[all_dfs_final.block_condition=='voice']
    ...
    all_dfs_final = all_dfs_final[all_dfs_final.trial_duration <= 26.796] # this is 90th percentile
